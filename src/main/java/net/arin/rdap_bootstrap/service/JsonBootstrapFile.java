/*
 * Copyright (C) 2014-2020 American Registry for Internet Numbers (ARIN)
 *
...
{
    /**
     * The various versions of the bootstrap are expected to pass in an implementation of this handler.
     */
    public interface Handler
    {
        ...
        void addServiceEntry( String entry );

        void addServiceUrl( String url );
